...
<div class="container">
    ...
    <form class="form-inline" action="addsemester.php" method="post">
    
    <div class="form-group">
      <label for="semester">Semester</label>
      <input type="semester" name="semester"class="form-control" id="semester" placeholder="Ex. Fall 2021">
      <br>
...
<div class="container">
    ...
    <div class="form-group">
      ...
      <input type="course" name="course"class="form-control" id="course" placeholder="Ex. Econ 101">
    </div>
